import { EKLE, ISARETLE, TEMIZLE } from "../actions/actionTypes";

const INITIAL_STATE={ liste: [
...
export const reducer= (state=INITIAL_STATE, action)=>{
    switch (action.type) {
        ...
        case ISARETLE:
            return {
                ...state,
                liste: state.liste.map(item=> item.id===action.payload?{...item, tamamlandi: !item.tamamlandi}:
                    item )
            };
        case TEMIZLE:
            return{
